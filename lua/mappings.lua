...
map('n', '<leader><leader>', ':FzfLua buffers<cr>', options)
...
map('n', '<leader>ff', ':FzfLua fzf_files<cr>', options)
...
map('n', '<leader>gs', '<cmd>vsplit term://git status<cr>', options)
map('n', '<leader>gl', '<cmd>vsplit term://git log<cr>', options)
map('n', '<leader>gd', '<cmd>vsplit term://git diff<cr>', options)
map('n', '<leader>gs', '<cmd>vsplit term://git --no-pager show<cr>', options)
